...
available_setting = {
    # groq api 配置
    "l-tutor-model": "llama3-groq-70b-8192-tool-use-preview",
    "groq_api_key": "",
    "groq_api_url": "",
    "toolhouse_api_key": "",
    # openai api配置
    ...
    "model": "l-tutor",  # 可选择: gpt-4o, pt-4o-mini, gpt-4-turbo, claude-3-sonnet, wenxin, moonshot, qwen-turbo, xunfei, glm-4, minimax, gemini等模型，全部可选模型详见common/const.py文件
